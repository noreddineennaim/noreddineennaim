...
![Media Production](https://img.shields.io/badge/CapCut%20%26%20After%20Effects-000000?style=for-the-badge&logo=capcut&logoColor=white)
...
### 🎙️ [DubNour — AI Video Dubbing & TTS Studio](https://github.com/noreddineennaim/DubNour-AI-Video-Dubbing-TTS-Studio)

> **Desktop application for video recap dubbing, storytelling, and multi-language AI audio generation using Google Gemini TTS, ElevenLabs, and FFmpeg.**

```
MP4 Video ➔ JSON Timings ➔ FFmpeg Split ➔ Gemini / ElevenLabs TTS ➔ AI Audio Generation ➔ Final Dubbed MP4
```

- **Dual AI Speech Engines**: Switch dynamically between **Google Gemini TTS** and **ElevenLabs TTS** with customizable voice models, speed controls (`0.5x`–`2.0x`), and emotional prompt prosody.
- **FFmpeg Frame Precision**: Video segmentation with **Accurate** (frame-precise re-encoding) or **Fast** (stream copy keyframe) modes.
- **Sequential Processing & Resilience**: Pause, resume, retry failed voiceover segments, and view real-time audio status.
- **Secure Credentials**: Native OS keychain integration via `keytar` alongside `.env` support.
- **Tech Stack**: Electron, React 18, TypeScript, Vite, FFmpeg, Google Gemini API, ElevenLabs API.
...
- **AI-Powered Analysis**: Evaluates file entropy, cryptographic hashes, and suspicious traffic logs.
- **Cryptographic Tools**: Built-in file encryption, certificate validation, and OpenSSL protocol diagnostics.
- **Tech Stack**: Python, C++, React, OpenSSL, Security Analysis Frameworks.

---

### 📝 SRT Translator Pro — AI Subtitle Translation Suite

> **Automated subtitle translation utility with contextual awareness and timestamp preservation.**

- **Batch Subtitle Processing**: Translates `.srt` and `.json` timed transcript files with high accuracy across languages.
- **Context Awareness**: Preserves subtitle timing, line breaks, and speaker nuances using AI APIs.
- **Tech Stack**: Electron, TypeScript, React, OpenAI & Gemini APIs.
...
[![Email](https://img.shields.io/badge/Email-noreddineennaim%40gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:noreddineennaim@gmail.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Noreddine%20EN--NAIM-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/noreddine-en-naim-b943a7271)
[![GitHub](https://img.shields.io/badge/GitHub-noreddineennaim-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/noreddineennaim)
...
<div align="center">
  <sub>Built with ❤️ by <b>Noreddine EN-NAIM</b> • Powered by AI, Data Science & Clean Code</sub>
</div>
